...
export declare const getAttestation: (credential: PublicKeyCredential) => WebauthnEnrollValues;
export declare const getAssertion: (credential: PublicKeyCredential) => WebauthnVerificationValues;
